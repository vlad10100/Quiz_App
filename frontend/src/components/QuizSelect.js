            ...
            <Container maxWidth="sm" component="main" className={classes.heroContent}>
              ...
              >
                ...
                <Container maxWidth='md' component='main'>
                    <Grid container spacing={5}  alignItems='flex-end' className={classes.gridPadding}>
                        {dataState.map((data, index) => 
                            <Grid item key={index} xs={6} md={4}> 
                                <Card>
                                    <CardHeader title={data.title} titleTypographyProps={{ align: "center" }} 
                                    ...
                                    <CardActions>
                                        <Button
                                            ...
                                            variant="outlined"
                                            color="primary"
                                            href={"http://localhost:3000/r/" + data.title}
                                        >
                                            Start Quiz 
                                        </Button>
                                    </CardActions>
